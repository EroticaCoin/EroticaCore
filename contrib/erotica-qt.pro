...
RESOURCES += src/qt/erotica.qrc src/qt/erotica_locale.qrc

TRANSLATIONS += src/qt/locale/erotica_bg.ts \
                src/qt/locale/erotica_de.ts \
                src/qt/locale/erotica_en.ts \
                src/qt/locale/erotica_es.ts \
                src/qt/locale/erotica_fi.ts \
                src/qt/locale/erotica_fr.ts \
                src/qt/locale/erotica_it.ts \
                src/qt/locale/erotica_ja.ts \
                src/qt/locale/erotica_pl.ts \
                src/qt/locale/erotica_pt.ts \
                src/qt/locale/erotica_ru.ts \
                src/qt/locale/erotica_sk.ts \
                src/qt/locale/erotica_sv.ts \
                src/qt/locale/erotica_vi.ts \
                src/qt/locale/erotica_zh_CN.ts \
                src/qt/locale/erotica_zh_TW.ts
