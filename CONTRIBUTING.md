Contributing to Erotica Core
============================

The Erotica Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Erotica Core project, and is not to be
confused with overall Erotica Network Protocol consensus changes.

Whether a pull request is merged into Erotica Core rests with the project merge
...
Patches that change Erotica consensus rules are considerably more involved than
...
Where a patch set proposes to change the Erotica consensus, it must have been
...
The project leader is the release manager for each Erotica Core release.
