...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Erotica Core erotica-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  erotica-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded erotica transaction") + "\n" +
                               "  erotica-tx [options] -create [commands]   " + _("Create hex-encoded erotica transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded erotica transaction
