/* src/config/erotica-config.h.  Generated from erotica-config.h.in by configure.  */
/* src/config/erotica-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EROTICA_CONFIG_H

#define EROTICA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.erotica.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Erotica Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Erotica Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "erotica"
