...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Erotica server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Erotica features */
        {"erotica", "masternode", &masternode, true, true, false},
        {"erotica", "listmasternodes", &listmasternodes, true, true, false},
        {"erotica", "getmasternodecount", &getmasternodecount, true, true, false},
        {"erotica", "masternodeconnect", &masternodeconnect, true, true, false},
        {"erotica", "masternodecurrent", &masternodecurrent, true, true, false},
        {"erotica", "masternodedebug", &masternodedebug, true, true, false},
        {"erotica", "startmasternode", &startmasternode, true, true, false},
        {"erotica", "createmasternodekey", &createmasternodekey, true, true, false},
        {"erotica", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"erotica", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"erotica", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"erotica", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"erotica", "getmasternodescores", &getmasternodescores, true, true, false},
        {"erotica", "mnbudget", &mnbudget, true, true, false},
        {"erotica", "preparebudget", &preparebudget, true, true, false},
        {"erotica", "submitbudget", &submitbudget, true, true, false},
        {"erotica", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"erotica", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"erotica", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"erotica", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"erotica", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"erotica", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"erotica", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"erotica", "checkbudgets", &checkbudgets, true, true, false},
        {"erotica", "mnsync", &mnsync, true, true, false},
        {"erotica", "spork", &spork, true, true, false},
        {"erotica", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"erotica", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use eroticad, or the -server option to erotica-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> erotica-cli " + methodname + " " + args + "\n";
}
