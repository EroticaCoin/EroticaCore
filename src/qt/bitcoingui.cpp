                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Erotica Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Erotica address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and erotica: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZTA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Erotica Core"), this);
    aboutAction->setStatusTip(tr("Show information about Erotica Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Erotica"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Erotica addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Erotica addresses"));
    ...
    openAction->setStatusTip(tr("Open a Erotica: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Erotica Core help message to get a list with possible Erotica command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Erotica Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Erotica network", "", count));
}
...
{
    QString strTitle = tr("Erotica Core"); // default title
...
/** Creates context menu, its actions, and eroticas up all the relevant signals for mouse events. */
