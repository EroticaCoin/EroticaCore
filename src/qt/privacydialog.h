...
public:
    ...
    void setZEroticaControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzZTA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzZTA_clicked();
    void on_pushButtonZEroticaControl_clicked();
