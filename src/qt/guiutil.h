...
/** Utility functions used by the Erotica Qt UI.
 */
namespace GUIUtil
{
...
// Render Erotica addresses in monospace font
...
// Parse "erotica:" URI into recipient object, return true on successful parsing
