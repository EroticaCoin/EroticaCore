...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000682dd102084b653f38d1743b94cda321a1936f57156974b76829b82d736"))
    ;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550446643, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0670a5a13eb54a2e37bd896127737138884fcc5cf7231fdf9a0e1c5ca61f023c36");
        nDefaultPort = 6969;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Erotica starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60;           // Erotica: 1 Minute Retarget
        nTargetSpacingSlowLaunch = 2 * 60;  // Erotica: 2 Minute Blocktime
        nTargetSpacing = 2 * 60;            // Erotica: 2 Minute Blocktime
        nMaturity = 60;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 6900000 * COIN;      // No more than 6900000 coins will ever be created.
        vZTADevKey = ParseHex("0333a2239ba4b1f8b9f9b71c16c1e568cb5bd0ce401d2789b7f628fad604c2151d");  // Dev1 Address
        vZTAFundKey = ParseHex("02a683ec3d2db868aca63aa4e817eef3dfe38ccc637ad444ca49f584a7861b57a2"); // Dev2 Address
        nDevFee = 4;                        // Dev1 = 4%
        nFundFee = 3;                       // Dev2 = 3%
        nDevFundForkBlock = 602;            // block that start paying dev and fund %
        ...
        const char* pszTimestamp = "Erotica is here - Built with love - 26 FEB 2019";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("07bc92b1f401860eea99e1a8a103effbd7e1c013a59a1a3a0c91c9d1997a0bc6f338567278c11344802838c107055bf7c1641eaed61e879245c255a4f5be5746fc") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1550449999;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 568403;
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000682dd102084b653f38d1743b94cda321a1936f57156974b76829b82d736"));
        assert(genesis.hashMerkleRoot == uint256("0xd7ea033995653fab8e59a34b7be78246ea8e56a70da931a15e3496ca1baef537"));
		...
		vSeeds.push_back(CDNSSeedData("209.250.242.215", "209.250.242.215"));         // Single node address
		vSeeds.push_back(CDNSSeedData("95.179.151.46", "95.179.151.46"));             // Single node address
		vSeeds.push_back(CDNSSeedData("45.32.149.219", "45.32.149.219"));             // Single node address
		vSeeds.push_back(CDNSSeedData("178.62.68.177", "178.62.68.177"));             // Single node address
		vSeeds.push_back(CDNSSeedData("178.62.67.100", "178.62.67.100"));             // Single node address
		vSeeds.push_back(CDNSSeedData("144.202.0.206", "144.202.0.206"));             // Single node address
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Erotica: 1 day
        nTargetSpacing = 1 * 60;  // Erotica: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 60;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet erotica addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet erotica script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet erotica BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet erotica BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet erotica BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Erotica: 1 day
        nTargetSpacing = 1 * 60;        // Erotica: 1 minutes
