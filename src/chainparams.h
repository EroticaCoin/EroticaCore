 ...
 * Erotica system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& xDNADevKey() const { return vZTADevKey; }
    const std::vector<unsigned char>& xDNAFundKey() const { return vZTAFundKey; }
...
protected:
    ...
    std::vector<unsigned char> vZTADevKey;
    std::vector<unsigned char> vZTAFundKey;
    int nDefaultPort;
