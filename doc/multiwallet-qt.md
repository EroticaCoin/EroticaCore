...
In order to support loading of multiple wallets in erotica-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is erotica.cpp.
...
Changes to erotica.cpp
----------------------
erotica.cpp is the entry point into erotica-qt, and as such, will require some minor modifications to provide hooks for
